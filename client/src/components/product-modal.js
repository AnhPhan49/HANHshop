...
const ProductModal = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    if (props.modalEditFilter) {
      setSpecify([...formatSpecifyData(props.modalEditFilter.specifications)]);
      ...
      setExistImageList(props.modalEditFilter.image);
    }
  ...
  const handleSubmitForm = async (e) => {
    ...
    try {
      ...
      specify.forEach((ele, i) => {
        formData.append("specifications", JSON.stringify(ele));
      });
  ...
  const handleChangeMedia = (e) => {
    ...
    if (
      file.length === 3 ||
      (props.modalEditFilter &&
        props.modalEditFilter.image.length + file.length === 3)
    ) {
              ...
              <form onSubmit={handleSubmitForm}>
                ...
                <FormGroup className={classes.FormGroup}>
                  ...
                  <FormHelperText id="component-error-text">
                    <h6>Giá tiền không được là giá trị âm (Đơn vị vnđ)</h6>
                  </FormHelperText>
                </FormGroup>
