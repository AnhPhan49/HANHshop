  ...
  return (
    <div className="production-page">
      ...
      <div className="row m-0 title">
        ...
        <div className="col-2 text-center">Sản phẩm</div>
        <div className="col-4 text-center">Miêu tả</div>
        <div className="col-2 text-center">Giá</div>
        <div className="col-1 text-center">Số lượng</div>
        <div className="col-2 text-center">Tùy chọn</div>
      </div>
        ...
        {inventoryList &&
          inventoryList.map((item, index) => (
            ...
            >
              ...
              <div
                className="col-4 product-item descript"
